...
public final class Settings {
	...
	public static ArrayList<Integer> GENERIC_GLOBAL_PLACEHOLDERS = new ArrayList<Integer>();
	...
	public static ArrayList<Integer> ANTISTOLLING_GLOBAL_PLACEHOLDERS = new ArrayList<Integer>();
	...
	public static ArrayList<Integer> DIGITAALLOGBOEK_GLOBAL_PLACEHOLDERS = new ArrayList<Integer>();
	
	//[CURRENT_DATE, HEADER_GIF, LOGIN_HTML, MESSAGE, MESSAGE_FOCUS, TD_NAME, TITEL_SCHERM, UITGELOGD_HTML, USER_NAME]
	public static ArrayList<Integer> SERVICECENTER_GLOBAL_PLACEHOLDERS = new ArrayList<Integer>();
